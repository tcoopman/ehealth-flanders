...
Security
Verzorgt de security van het systeem.  Deze compononent bestaat uit twee subcomponenten.

Compression:
Verantwoordelijk voor compressie en decompressie van data.

Authentication:
Kan controleren of de indentiteit van een bericht correct is (\textit{identify}) en kan berichten aftekenen (sign)
