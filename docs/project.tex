...
Deze laag is verantwoordelijk voor het opslaan van de lokale data cache en onderhoudt consistentie tussen lokale cache en external data server.
Voor de bovenliggende laag zijn de excate locatie van de GMRs niet van belang noch hoe de data gecomprimeerd en beveiligd is. Deze laag camoufleert het verschil tussen de lokale cache en de server data en voorziet standaard data transformatie (transformatie tussen volledige uitgepakt vorm die gebruikt kan worden door de gebruiker en beveiligde/gecomprimeerde vorm voor data opgeslag).\\

\underline{Data Management}\\
Voorziet toegang voor alle data, co\"{o}rdineert de nodige verwerkingen van data.\\
Meer info zie Deployment View\\
...
\paragraph{Physical Data Layer}
Data behandeling op fysiek - niveau\\
...
In principe is de data die op de Physical Data laag terug te vinden is "onbruikbaar" in de zin van dat er geen volledige dossier-bestanden te vinden zijn.  De fysieke data laag is wel verantwoordelijk voor de duplicatie (dit is ten gunste van de performantie en availability).
\subsection{Other information}
[Geen]
