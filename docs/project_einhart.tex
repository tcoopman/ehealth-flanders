...
%TODO: is dit stuk hieronder wel rationale? misschien bij stakeholders?
...
-Software Layer: naam, verantwoordelijkheid (Voornaamste inhoud van elke laag is terug te vinden in Uses View)\\
...
Verantwoordelijkheid:\\
Bevat toepassingsspecifieke applicaties die afhankelijk van gebruiker kan varieën. Een gemeenschapeelijk punt tussen deze applicaties is dat ze toegang tot medische dossieren nodig hebben.
\\
...
-Software Layer Component: naam, verantwoordelijkheid\\
...
Client Application\\
Toepassingsspecifieke applicaties die afhankelijk van gebruiker kan varieën.\\
...
Sibling: Layered/Uses View: Server\\
...
%\begin{center}
%\begin{figure}[h!]
%\includegraphics[width=\textwidth]{../images/UsesView_Server.jpg}
%\end{figure}
%\end{center}
...
%TODO: identify kijkt of de gebruiker wel degelijk dit bericht verstuurd heeft.
